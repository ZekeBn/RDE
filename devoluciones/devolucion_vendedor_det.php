...
$rs_vendedor_detalle = $conexion->Execute($consulta) or die(errorpg($conexion, $consulta));
...
<p>
  <a href="devolucion_ranking.php?filter=3" class="btn btn-sm btn-default"><span class="fa fa-reply"></span> Regresar</a>
</p>
...
<div class="table-responsive">
    <table width="100%" class="table table-bordered jambo_table bulk_action">
		<tr>
			...
			<td align="center"><?php echo antixss($rs_vendedor_detalle->fields['idvendedor']); ?></td>
		</tr>
        <tr>
			<th align="center">Nombres</th>
			<td align="center"><?php echo antixss($rs_vendedor_detalle->fields['nombres']); ?></td>
		</tr>
        <tr>
			<th align="center">Apellidos</th>
			<td align="center"><?php echo antixss($rs_vendedor_detalle->fields['apellidos']); ?></td>
		</tr>
        <tr>
			<th align="center">Carnet</th>
			<td align="center"><?php echo antixss($rs_vendedor_detalle->fields['carnet']); ?></td>
		</tr>
    </table>
</div>
<br />
