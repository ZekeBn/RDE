...
->setCellValue('B1', antixss($rsf->fields['descripcion']).' - ENTRADAS ')
...
while (!$rs->EOF) {
    ...
    $pcvalorizado = $rs->fields['costo_receta'] * $totentrada;
...
$objPHPExcel->setActiveSheetIndex(0);
$ile = 'pla_entradas_'.$current.'.xlsx';
