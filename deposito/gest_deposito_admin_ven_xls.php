...
and idproducto > 0
and idproducto in (select idproducto from productos_sucursales where idsucursal = $sucursal_deposito and activo_suc = 1)
$whereadd	
...
$objPHPExcel->getActiveSheet()->getStyle("A1:AE1")->getFont()->setSize(12)
->setBold(true);
