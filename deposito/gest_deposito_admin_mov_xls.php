...
->setCellValue('C2', 'P. Compra')
->setCellValue('D2', 'Traslado Entrante')
->setCellValue('E2', 'Compras')
->setCellValue('F2', 'Total Entradas')
->setCellValue('G2', 'N. Credito')
->setCellValue('H2', 'Traslado Saliente')
->setCellValue('I2', 'Total Salidas')
->setCellValue('J2', 'PC Valorizado')

;


$objPHPExcel->getActiveSheet()->getStyle("A2:K2")->getFont()->setSize(12)
->setBold(true);
...
while (!$rs->EOF) {
    ...
    $totentrada = ($rs->fields['tentrada'] + $rs->fields['compra']);
    $totsalida = ($rs->fields['tsalida'] + $rs->fields['ncredito']);
    ...
    ->setCellValue('C'.$i, $rs->fields['ultimocosto'])
    ->setCellValue('D'.$i, $rs->fields['tentrada'])
    ->setCellValue('E'.$i, $rs->fields['compra'])
    ->setCellValue('F'.$i, $totentrada)
    ->setCellValue('G'.$i, $rs->fields['ncredito'])
    ->setCellValue('H'.$i, $rs->fields['tsalida'])
    ->setCellValue('I'.$i, $totsalida)
    ->setCellValue('J'.$i, $valorizado_pc)
