...
->setCellValue('B1', antixss($rsf->fields['descripcion']).' - PERDIDAS ')
...
->setCellValue('D2', 'N. Credito')
->setCellValue('E2', 'Traslado Saliente')
->setCellValue('F2', 'Tot. Salidas')
->setCellValue('G2', 'PC Valorizado')
...
while (!$rs->EOF) {
    ...
    $pcvalorizado = $rs->fields['costo_receta'] * $totentragadagen;
    // grupo de insumos

    $totsalida = $rs->fields['ncredito'] + $rs->fields['tsalida'];
    ...
    ->setCellValue('D'.$i, $rs->fields['ncredito'])
    ->setCellValue('E'.$i, $rs->fields['tsalida'])
    ->setCellValue('F'.$i, $totsalida)
    ->setCellValue('G'.$i, $pcvalorizado)
