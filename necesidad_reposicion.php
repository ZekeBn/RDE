          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Informe de Necesidad de Reposicion</h2>
...
$parametros_array = [
    ...
    'acciones' => ' required="required" onchange="document.location.href=\'necesidad_reposicion.php?iddeposito=\'+this.value" ',
    'autosel_1registro' => 'S'
    ...
    <table width="100%" class="table table-bordered jambo_table bulk_action">
	  <thead>
		<tr>
            ...
            <th align="center">Cant. x Paquete</th>
			<th align="center">Paquetes Reponer</th>
            <th align="center">Cant. según Paq.</th>
		</tr>
	  </thead>
	  <tbody>
<?php while (!$rs->EOF) {
    ...
    $cant_paquete = $rs->fields['cant_paquete'];
    //$total_vueltas_necesarias=ceil(($diferencia*-1)/$cantidad_porvuelta);
    $total_paquete_necesarias = round(($diferencia * -1) / $cant_paquete, 0);
    $cantidad_segun_paq = $total_paquete_necesarias * $cant_paquete;
    ?>
		<tr>
			...
			<td align="center"><?php echo formatomoneda($cant_paquete, 4, 'N'); ?></td>
            <td align="right"><?php echo formatomoneda($total_paquete_necesarias, 4, 'N');  ?></td>
            <td align="right"><?php echo formatomoneda($cantidad_segun_paq, 4, 'N');  ?></td>
		</tr>
<?php $rs->MoveNext();
} //$rs->MoveFirst();?>
	  </tbody>
