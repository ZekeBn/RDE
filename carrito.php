        ...
        if ($medida == 4) {
            ...
            if ($cantidad < 10) {
                ...
                for ($i = 1;$i <= $cantidad;$i++) {
					...
					(idproducto, idtipoproducto, cantidad, precio, fechahora, usuario, registrado, idsucursal, idempresa, receta_cambiada, borrado, combinado, idprod_mitad1, idprod_mitad2,subtotal,idlistaprecio,idpedidocat,idtmpventares_cab, desconsolida_forzar) 
					VALUES 
					($producto, $idtipoproducto,1,$precio, $fechahora,$usuario, $registrado, $idsucursal, $idempresa, $receta_cambiada, $borrado, $combinado, $prod_1, $prod_2,$precio,$lista_precio_my,$idpedidocat,$idtmpventares_cab, $desconsolida_forzar)
					;
					";
                    $conexion->Execute($consulta) or die(errorpg($conexion, $consulta));
                    //echo $consulta;
