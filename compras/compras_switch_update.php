...
// se reemplazo por js
$html_checkbox = '<input name="compra_cot_despacho" id="compra_cot_despacho" type="checkbox" value="S" class="js-switch" onChange="registrar_cot_despacho('.$idcompra.'); " '.$checked.' />';
