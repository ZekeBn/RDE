...
<style>
	...
	<script>
		function ver_cotizacion_set(){
			...
			$.ajax({		
					...
					success:  function (response) {
						...
						$("#contenedor #box_cotizacion_set").removeClass("hidden");
		...
		function cerrar_pop_select(){
			$("#modal_ventana").modal("hide");
		}

		function agregar_moneda_modal(){
			var direccionurl='select_cotizacion.php';	
			var parametros = {
...
<div class="colcompleto" id="contenedor">  	 	
	...
	<div style="text-align:center;display:none;" id="box_cotizacion_set" class="alert alert-info">
		<button type="button" class="close" onclick="cerrar_alert()" aria-label="Close"><span >×</span>
		</button>
