      ...
      var parametros = {
       ...
       $.ajax({
                ...
                success:  function (response) {
                  ...
                  $("#modal_titulo").html('Detalles de Factura');                  
                  $("#modal_cuerpo").html(response);
                }
        });	
    }
    function generar_reporte_compra(idCompra){
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="gest_reg_compras_resto_new.php" class="btn btn-sm btn-default"><span class="fa fa-reply"></span> Volver</a>
...
<?php while (!$rs->EOF) { ?>
		<tr>
			<td>
				...
				<div class="btn-group">
					<a href="javascript:void(0)" class="btn btn-sm btn-default"  onclick = "detalles_factura(<?php echo $rs->fields['idcompra']; ?>)"title="Detalle" data-toggle="tooltip" data-placement="right"  data-original-title="Detalle"><span class="fa fa-search"></span></a>
					<a href="javascript:void(0)" onclick="generar_reporte_compra(<?php echo $rs->fields['idcompra']; ?>)" class="btn btn-sm btn-default" title="Editar" data-toggle="tooltip" data-placement="right"  data-original-title="Editar"><span class="fa fa-print"></span> Generar Reporte</a>
				</div>
