...
if ($editar_traslado != 'S') {
    $whereadd = "
	and gest_transferencias.origen in 
		(
		select iddeposito 
...
<?php while (!$rs->EOF) { ?>
		<tr>
			<td>
				...
				<div class="btn-group">
					<a href="gest_transferencias_imp.php?id=<?php echo $rs->fields['idtanda']; ?>" class="btn btn-sm btn-default" title="Imprimir PDF" data-toggle="tooltip" data-placement="right"  data-original-title="Imprimir PDF"><span class="fa fa-file-pdf-o"></span></a>
                    <a href="gest_transferencias_imp_tk.php?id=<?php echo $rs->fields['idtanda']; ?>" target="_blank" class="btn btn-sm btn-default" title="Imprimir TICKET" data-toggle="tooltip" data-placement="right"  data-original-title="Imprimir TICKET"><span class="fa fa-print"></span></a>
                    <?php if ($editar_traslado == 'S') { ?>
