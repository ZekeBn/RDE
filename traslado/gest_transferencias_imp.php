...
if ($tanda > 0) {
    ...
    $consulta = "
	select tipo_pantalla, valoriza_reposicion, usa_controladopor from preferencias_transfer limit 1
	";
    $rspreftran = $conexion->Execute($consulta) or die(errorpg($conexion, $consulta));
    $tipo_pantalla = $rspreftran->fields['tipo_pantalla']; // E: estandar  C: completo
    $valoriza_reposicion = $rspreftran->fields['valoriza_reposicion'];
    $usa_controladopor = $rspreftran->fields['usa_controladopor'];
    if ($valoriza_reposicion == 'S') {
        $mostrarcosto = "S";
    }
    //echo $usa_controladopor;exit;
    $consulta = "
	select verstock_traslado from usuarios where idusu = $idusu limit 1
	";
    $rsusuperm = $conexion->Execute($consulta) or die(errorpg($conexion, $consulta));
    $verstock_traslado = $rsusuperm->fields['verstock_traslado'];
...
/*if ($mostrarcosto=='S'){
    ...
    <tr>
     <td  colspan=\"6\" align=\"center\" bgcolor=\"#E4E4E4\"><strong>Art&iacute;culos</strong></td></tr>";
}else{
    $html1.="<table width=\"480\" align=\"center\" border=\"1\"  style=\"border-collapse:collapse;\">
    <tr>
     <td  colspan=\"4\" align=\"center\" bgcolor=\"#E4E4E4\"><strong>Art&iacute;culos</strong></td></tr>";
}*/
...
$html1 .= "
	...
	";
if ($tipo_pantalla == 'C') {
    $html1 .= "<td  align=\"center\" bgcolor=\"#E4E4E4\"><strong><em>N&ordm;</em></strong></td>";
}
...
if ($tipo_pantalla == 'C') {
    $html1 .= "<td  align=\"center\" bgcolor=\"#E4E4E4\"><strong><em>Stock Ideal Destino</em></strong></td>";
    $html1 .= "<td  align=\"center\" bgcolor=\"#E4E4E4\"><strong><em>Stock Actual Destino</em></strong></td>";
}

$html1 .= "<td  align=\"center\" bgcolor=\"#E4E4E4\"><strong><em>Cantidad</em></strong></td>";
...
while (!$rscuerpo->EOF) {
    ...
    if ($tipo_pantalla == 'C') {
        $html2 .= "<td align=\"right\">".formatomoneda($rscuerpo->fields['stock_ideal_destino'], 4, 'N')."</td>";
        $html2 .= "<td align=\"right\">".formatomoneda($rscuerpo->fields['stock_destino'], 4, 'N')."</td>";
    }
...
if ($tipo_pantalla == 'C') {
    $html2 .= "<td align=\"right\"></td>";
    $html2 .= "<td align=\"right\"></td>";
    $html2 .= "<td align=\"right\"></td>";
}
$html2 .= "<td align=\"right\">".formatomoneda($cantacum, 4, 'N')."</td>";
