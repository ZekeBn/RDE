...
<?php while (!$rs->EOF) { ?>
		<tr>
			<td>
				...
				<div class="btn-group">
					<a href="proveedores_res.php?id=<?php echo $rs->fields['idproveedor']; ?>" class="btn btn-sm btn-default" title="Restaurar" data-toggle="tooltip" data-placement="right"  data-original-title="Restaurar"><span class="fa fa-recycle"></span></a>
				</div>
