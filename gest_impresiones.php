...
// script de impresion factura
// $consulta="
// select filtros_reimp, reimpresion_muestra_cant, pdf_en_reimpresion_caja from preferencias_caja  limit 1
// ";
$consulta="
...
// $pdf_en_reimpresion_caja=$rspc->fields['pdf_en_reimpresion_caja'];
$pdf_en_reimpresion_caja='N';
...
$consulta="select reimprime_encaja from usuarios where idusu = $idusu ";
$rsusc=$conexion->Execute($consulta) or die(errorpg($conexion,$consulta));
$reimprime_encaja=$rsusc->fields['reimprime_encaja'];
...
<div class="table-responsive">
    ...
    <thead>
                       <tr>
                        ...
                        <?php if($pdf_en_reimpresion_caja == 'S'){ ?> 
                        <th><strong>Factura PDF</strong></th>
                        <?php } ?>
                    </tr>
    </thead>
    <tbody>
...
<?php } ?>
                        ...
                        <?php } ?></span></td>
                        <?php  if($pdf_en_reimpresion_caja == 'S'){ ?> 
                        <td><?php if($factura != ''){  ?><a href="factura_imprime_impresor_sincaja_vp.php?vta=<?php echo $vta ;?>" target="_blank" class="btn btn-sm btn-default" title="" data-toggle="tooltip" data-placement="right" data-original-title="Vista Previa Factura"><span class="fa fa-file-pdf-o"></span> F</a><?php } ?></td>
                        <?php  } ?>
                    </tr>
                    <?php $rsvv->MoveNext();}?>
                    </tbody>
...
<?php }else{ // if($reimprime_encaja == 'S'){ ?>
<h3>Tu usuario no tiene permisos para hacer reimpresiones en este modulo.</h3>
<?php } ?>
<br /><br /><br /><br /><br />
