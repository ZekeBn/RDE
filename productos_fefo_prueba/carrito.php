...
$carry_out = trim($rspref->fields['carry_out']); //S
$alerta_ventas = trim($rspref->fields['alerta_ventas']); // NULL
$forzar_agrupacion = trim($rspref->fields['forzar_agrupacion']); //N
$agrupa_ventadet = trim($rspref->fields['agrupa_ventadet']); //N
$max_items_factura = intval($rspref->fields['max_items_factura']); // 6
