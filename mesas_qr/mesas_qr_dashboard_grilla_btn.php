        ...
        <div class="flex flex-wrap -mx-4">
            <div  class="w-full md:w-1/3 px-4 mb-8 <?php if ($idpedido_mesero > 0) {
                ...
                <div id="mesero" onclick="<?php if ($idpedido_mesero > 0) {
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Solicitar un mesero </h3>
                    <p class="text-gray-600">Presiona el Boton y un mesero se acercara en la brevedad</p>
                </div>
            </div>
            <div class="w-full md:w-1/3 px-4 mb-8">
                <div id="box_ver_pedidos"><?php require_once("./mesas_qr_pedidos_grilla.php");?></div>
            </div>
            <div class="w-full md:w-1/3 px-4 mb-8 <?php if ($idpedido_cuenta > 0) {
                ...
                <div id="pedir_cuenta" onclick="<?php if ($idpedido_cuenta > 0) {
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Pedir Cuenta </h3>
                    <p class="text-gray-600">
                    Al solicitarlo un mesero se acercara en la brevedad posible, si su ruc y razon social fue agregado al perfil la factura electronica sera asociada si asi lo desea.
                    </p>
                </div>
            </div>
        </div>
