...
<div class="cards">
    ...
    <div  id="mesero_box" class="boton-container <?php if ($idpedido_mesero > 0) {
        ...
        <div id="mesero" onclick="finalizar_pedido_mesero()" class="<?php if ($idpedido_mesero > 0) {
            echo "activo";
        }?> boton-body">
          <i class="fa fa-users "></i>
          <h3 id="mesero_titulo" class="">Confirmar atenci&oacute;n</h3>
          <p id="mesero_texto" class="">Al presionar el bot&oacute;n, la solicitud de la mesa se marcará como atendida y se guardar&aacute; el registro de la atenci&oacute;n.</p>
        </div>
    </div>
    ...
    <div id="pedir_cuenta_box" class="boton-container <?php if ($idpedido_cuenta > 0) {
        ...
        <div id="pedir_cuenta" onclick="finalizar_pedir_cuenta()" class="<?php if ($idpedido_cuenta > 0) {
            echo "activo";
        }?> boton-body">
            <i class="fas fa-list-check text-4xl text-blue-500 mb-4"></i>
            <h3 id="pedir_cuenta_titulo" class="text-xl font-bold text-gray-800 mb-2">Confirmar Cuenta Entregada</h3>
            <p  id="pedir_cuenta_titulo" class="text-gray-600">
