...
<script>
    ...
    function reload_buttons(){
      var direccion="mesas_qr_dashboard_grilla_btn.php";
      var parametros = {
            "reload" : 1
      };
      ...
      $.ajax({
                ...
                success:  function (response) {
                  console.log("boton actualizado");
                  $("#box_grilla_btn").html(response);
                }
        });	
    }
    function solicitar_mesero(){
      var html_solicita = '';
      var html_cancela = '';
      //var html_ant = $("#mesero").html();
    ...
    function cancelar_pedido_mesero(){
    ...
    function ver_pedido(){
      var direccion="mesas_qr_pedidos_grilla.php";
      var parametros = {
        "ver_pedido"   : 1
      };
      // parametros = JSON.stringify(parametros);
    ...
    function cancelar_pedir_cuenta(){
      var direccion="mesas_qr_eliminar_pedido.php";
      var parametros = {
            "id_mesa"   : <?php echo $id_mesa ;?>,
            "tipo_pedido" : 2
...
<div id="box_grilla_btn">
  <?php require_once("mesas_qr_dashboard_grilla_btn.php");?>
</div>
