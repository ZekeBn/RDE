    ...
    if ($preferencia_usa_pin == "S") {
        ...
        if (($_SESSION['pin_atc_cliente']) != "") {
            ...
            if ($pin_atc == $pin_atc_cliente) {
                ...
                header("Location: ./mesas_qr_dashboard2.php");
            ...
            if ($preferencia_cliente_gen_pin == "S") {
                if ($pin_atc == "") {
                    ...
                    // echo "Pin generado por el cliente";
                    // echo $uuid_cliente;

                    //redirigir a la botonera
                    header("Location: ./mesas_qr_dashboard.php");
...
<style>
    .resized-image {
    width: 460px; /* Nuevo ancho deseado */
    height: 180px; /* Nueva altura deseada */
    /* Otras propiedades que desees añadir, como bordes redondeados y sombras */
    border-radius: 10px;
    box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);
    /* Asegúrate de que la imagen mantenga su relación de aspecto con 'object-fit' */
    object-fit: cover;
}
...
<body>
<!-- Snippet -->
<section class="antialiased bg-gray-100 text-gray-600 min-h-screen p-6 ">
