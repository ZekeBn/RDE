...
<br />	<br /><br />	
            ...
            <!-- SECCION --> 
              ...
              <?php
                $buscar = "Select archivo,descripcion,(select usuario from usuarios where idusu=cliente_legajo.registrado_por) as quien,cliente_legajo.registrado_el,unsf, cliente_legajo.comentario,cliente_legajo.nombre_antiguo_arch
				from cliente_legajo 
