...
?>
<script>
    function agregar_cotizacion_modal(event,idcot,cotizacion,fecha){
    ...
    ?>
		<tr>
			<td>
				...
				<div class="btn-group">
					<a href="javascript:void(0)" onclick="agregar_cotizacion_modal(event,<?php echo $idcotizacion; ?>,<?php echo $cot_venta; ?>,'<?php echo date('d/m/Y', strtotime($rs->fields['fecha'])); ?>')" class="btn btn-sm btn-default" title="Select" data-toggle="tooltip" data-placement="right"  data-original-title="Select"><span class="fa fa-check"></span>Seleccionar</a>
