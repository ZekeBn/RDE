...
<div class="form-group">
	...
	<button type="submit"  name="reg" class="btn btn-success" onClick="registrar_cliente(<?php echo $idpedido; ?>);"><span class="fa fa-check-square-o"></span> Registrar Cliente</button>
    </div>
</div>
