    ...
    ?>
			...
			<td>
				...
				<div class="btn-group">
					...
					<a href="javascript:void(0);" onMouseUp="chau(<?php echo $rspedicu->fields['idtmpventares_cab']?>)" class="btn btn-sm btn-default" title="Borrar" data-toggle="tooltip" data-placement="right"  data-original-title="Borrar"><span class="fa fa-trash-o"></span></a>
				</div>
