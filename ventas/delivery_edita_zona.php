...
if (isset($_POST['MM_update']) && $_POST['MM_update'] == 'form1') {
    ...
    $consulta = " select * from gest_zonas where descripcion = $zona and idsucursal = $idsucu and idzona <> $idzona ";
            ...
            <table width="400" border="1">
              <tbody>
                <tr>
                  ...
                  <td>
                  <input type="text" name="zona" id="zona" value="<?php echo $rszonas->fields['descripcion']?>" /></td>
                </tr>
                <tr>
                  <td align="right"><strong>Costo Entrega:</strong></td>
                  <td>
                  <input type="text" name="costoentrega" id="costoentrega" value="<?php echo intval($rszonas->fields['costoentrega']);?>" /></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="idsucursal" id="idsucursal">
                               ...
                               <?php while (!$rsfd->EOF) {?>
                            	<option value="<?php echo $rsfd->fields['idsucu']?>" <?php if ($rsfd->fields['idsucu'] == $rszonas->fields['idsucursal']) {?>selected="selected"<?php }?>><?php echo $rsfd->fields['nombre']?></option>
