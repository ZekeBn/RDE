...
if ($idt == 0) {
    ...
    if ($idt == 0) {
        ...
        if ($idt == 0) {
            ...
            //buscamos el nuevo
            $buscar = "Select max(numero) as mayor from transacciones where tipo=3 and idusu=$idusu and estado=1";
...
function vuelto(monto){
	if (monto!=''){
		...
		if (monto > 0){
			//Por seguridad, recalculaos el total de la venta
			var tven=parseInt(document.getElementById('tventa').value);
			...
			if (document.getElementById('totlaventaf')){
				...
				if (totalventa > 0){
					if (totalventa > tven){
						document.getElementById('tventa').value=totalventa;
