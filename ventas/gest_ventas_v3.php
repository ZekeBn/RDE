...
$estadocaja = intval($rscaja->fields['estado']);
...
<script>
	...
	function activar(cual){
		...
		OpenPage('bcliemin3.php',parametros,'POST','adicio','pred');
...
<body bgcolor="#FFFFFF" onLoad="<?php if (intval($imprimir) == 1) {?> <?php if ($metodo == 1) {?>envia(2);<?php } else {?>envia(1);<?php }
} ?>activar(1);">
<div class="clear"></div>
<?php require("includes/cabeza.php"); ?>
<div style="border:0px solid #000000; width:200px; height:220px; float:left; background-color:#FFFFFF; margin-top:5%;">
<div class="resumenmini">
            <img src="img/1444616944_info.png" width="32" height="32" alt=""/><br />
            <span style="font-size:12px;">
            <table width="195">
            	<tr>
                	<td width="102" align="center" style="border-bottom:groove;"><strong>Teclas r&aacute;pidas</strong></td>
                    <td width="243" align="center"  style="border-bottom:groove;"><strong>Acci&oacute;n</strong></td>
                    
            	</tr>
                <tr>
                	<td align="center">T</td>
                    <td align="left">Imprimir documento seleccionado (tk/fc)</td>
                
                </tr>
                <tr>
               	  <td align="center">L</td>
                    <td align="left">Busqueda r&aacute;pida de productos</td>
...
<div class="cuerpo">
    ...
    <div class="colcompleto" id="contenedor">
                ...
                <tbody>
                    <tr>
                       <td width="62"><a href="index.php"><img src="img/homeblue.png" width="64" height="64" title="Regresar"/></a></td>
                        <td width="62"><a href="gest_reimpresion.php" target="_blank"><img src="img/1458502603_printer.png" width="64" height="64" title="Rempresion de documentos"/></a></td>
                    </tr>
                </tbody>
           </table><a href="#pop2" id="enlace2" onClick="lprodu();" hidden="hidden">fff</a>
      </div>
        <!------------------------------600------------------------------------------------->
        <div id="impresion">
        ...
        <br />
        <div class="resumenmini850" style="height:220px;">
       		<form id="regventa" name="regventa" method="post" action="gest_ventas_v3.php">
            <input type="hidden" name="fin" id="fin" value="<?php echo $idt?>" />
            <input type="hidden" name="metodo" id="metodo" value="0" />
            <div class="divizquierda300">
                 <table width="250" border="1">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2">
                                 <input type="text" name="bcli" id="blci" onKeyUp="filtrar()" placeholder="Filtrar clientes" style="width:200px; height:40px;" />
                            <a href="#pop1" onMouseOver="asignarv();" title="Registrar Nuevo"><img src="img/02p64.png" width="30" height="30" alt=""/>  </a>                          </td>
                        </tr>
                         <tr  id="buscl">
                            <td colspan="2">
                                 <div id="clientereca">
                                    <?php require_once("gest_cliev3venta.php"); ?>
            ...
            <div class="divizquierdam6" style="width:580px">
               <table width="580"> 
               <tr>
               <td colspan="4" align="center">
               <strong>Tipo Documento:</strong>
               <input type="button" name="tk" id="tk" value="Tickete" onClick="tipodocu(1);" style="background-color:#FF0004; color:#FFFFFF" />
               &nbsp;
               <input type="button" name="fc" id="fc" value="Factura"  onclick="tipodocu(2);" />
               </td>
               </tr>
                 <tr>
                            <td width="95" height="28" align="center" bgcolor="#F1EFEF"><strong>Cond. de Venta</strong></td>
                            <td width="137" height="28" align="center" bgcolor="#F1EFEF"><strong>Fecha Venta</strong></td>
                            <td width="154" align="center" bgcolor="#F1EFEF"><strong>Factura N&uacute;mero</strong></td>
                            <td width="144" align="center" bgcolor="#F1EFEF">
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="suc" id="suc" style="width:30px" value="001" />
                                <input type="text" name="pe" id="pe" style="width:30px" value="001" />
                                <input type="text" name="nf" id="nf" style="width:80px" value="" />
                        </td>
                        <td>
                            <select id="formapago" name="formapago" onChange="mediopago(this.value)">
  ...
  <tbody>
    <tr>
      <td width="67%"><input type="text" name="prodbus" id="prodbus" placeholder="Escanear / ingresar codigo del Producto"  
                style="width:95%; height:40px;"  /></td>
      <td width="33%"><input type="text" name="cantidad" id="cantidad" value=""  style="height:40px;" placeholder="Cantidad" /></td>
    </tr>
        ...
        <div id="pop2" class="mfp-hide" style="background-color:#F9F7F7; width:400px; height:auto; margin-left:auto; margin-right:auto;">
