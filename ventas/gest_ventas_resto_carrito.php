...
?></td>
      ...
      <td align="center"><?php echo antixss($rs->fields['vencimiento']); ?></td>
...
<?php } ?>
	  <input type="hidden" name="occliedefe" id="occliedefe" value="<?php echo $rsoclci->fields['idcliente']?>" />
        ...
        <a href="delivery_pedidos.php" class="btn btn-sm btn-default"><span class="fa fa-motorcycle"></span> Tomar Delivery</a>
<?php if ($carry_out == 'S'){ ?>        &nbsp;
