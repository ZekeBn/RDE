...
<?php if (trim($title_personaliza) == '') { ?>
	<title><?php echo $rsco->fields['nombre_sys']; ?> - <?php echo $nombreempresa; ?></title>
<?php } else { ?>
...
<?php } ?>
    ...
    <!-- Font Awesome -->
    <link href="<?php echo $dirini; ?>vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    ...
    <!-- Custom Theme Style -->
    <link href="<?php echo $dirini; ?>build/css/custom.min.css" rel="stylesheet">
    <!-- Nuestros CSS -->
    <link href="<?php echo $dirini; ?>css/nuestrosys.css" rel="stylesheet">
