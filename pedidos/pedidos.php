...
$order = " order by codigo_cliente desc ";
...
<p>
<!-- <a href="pedidos_add.php" class="btn btn-sm btn-default"><span class="fa fa-plus"></span> Agregar Pedidos</a>  -->
<a href="pedidos_add3.php" class="btn btn-sm btn-default"><span class="fa fa-plus"></span> Agregar Pedidos</a> 
<a href="cliente_borrado.php" class="btn btn-sm btn-default"><span class="fa fa-search"></span> Consultar Pedidos</a>
<a href="cliente_importar.php" class="btn btn-sm btn-default"><span class="fa fa-trash"></span> Anular Pedidos</a>
</p>
<hr />
...
<?php while (!$rs->EOF) { ?>
		<tr>
			<td>
				...
				<div class="btn-group">
					<a href="pedidos_edit.php?id=<?php echo $rs->fields['idcliente']; ?>" class="btn btn-sm btn-default" title="Editar" data-toggle="tooltip" data-placement="right"  data-original-title="Editar"><span class="fa fa-edit"></span></a>
					...
					<a href="cliente_vend.php?id=<?php echo $rs->fields['idcliente']; ?>" class="btn btn-sm btn-default" title="Vendedor" data-toggle="tooltip" data-placement="right"  data-original-title="Vendedor"><span class="fa fa-user"></span></a>
					<?php } ?>
			...
			<td align="center"><?php echo antixss(number_format($rs->fields['total_neto'], 2)); ?></td>
			<td align="center"><?php echo antixss(number_format($rs->fields['total_impuestos'], 2)); ?></td>
			<td align="center"><?php echo antixss(number_format($rs->fields['total_final'], 2)); ?></td>
			<td align="center"><?php echo antixss(date('d-m-Y', strtotime($rs->fields['emision']))); ?></td>
