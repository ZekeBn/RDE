...
compras_ordenes.estado =2 and compras_ordenes.ocnum_ref is  NULL
";
		...
		<tr>
			<td>
				...
				<div class="btn-group">
					...
					<a href="reportes_ordenes.php?ocnum=<?php echo $rs->fields['ocnum']; ?>" class="btn btn-sm btn-default" title="Select" data-toggle="tooltip" data-placement="right"  data-original-title="Select"><span class="fa fa-check"></span>Seleccionar</a>
