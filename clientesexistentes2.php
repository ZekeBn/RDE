...
<div class="col-md-4 col-sm-4 form-group">
	...
	<input type="text" name="blci" id="blci" onKeyPress="filtrar_rz(<?php echo $tpago?>,<?php echo $idpedido?>);" placeholder="Buscar x Razon Social"  class="form-control">
</div>

<div class="col-md-4 col-sm-4 form-group">
	<input type="text" name="blci2" id="blci2" onKeyPress="filtrar_ruc(<?php echo $tpago?>,<?php echo $idpedido?>);" placeholder="Buscar x  RUC"  class="form-control" />
</div>


<div class="col-md-4 col-sm-4 form-group">
	<input type="text" name="blci3" id="blci3" onKeyPress="filtrar_doc(<?php echo $tpago?>,<?php echo $idpedido?>);" placeholder="Buscar x  Cedula"  class="form-control" />
</div>
...
<div id="clientereca">
    <select size="10" style="width:100%; height: 250px;" name="cliente" id="cliente" onChange="selecciona_cliente(this.value,<?php echo $tpago?>,<?php echo $idpedido?>);">
                <?php while (!$rscli->EOF) {
                    $array = "";
                    $array = [
