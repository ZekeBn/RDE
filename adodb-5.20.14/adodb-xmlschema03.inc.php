    ...
    public function addFieldOpt($field, $opt, $value = null)
    {
        if ($this->currentPlatform) {
            if (!isset($value)) {
                ...
                $this->fields[$this->FieldID($field)]['OPTS'][] = [ $opt => $value ];
            }
        }
    }
    ...
    */
    public function create(&$xmls)
    {
        ...
        foreach ($this->data as $row) {
            ...
            $fields = [];
            $rawfields = []; // Need to keep some of the unprocessed data on hand.
...
class adoSchema
{
    ...
    */
    ...
    public function TransformSchema($schema, $xsl, $schematype = 'string')
    {
        ...
        // set error handler
        xslt_set_error_handler($xh, [&$this, 'xslt_error_handler']);
