...
class ADODB_pdo extends ADOConnection
{
    ...
    public function Concat()
    {
        ...
        if (method_exists($this->_driver, 'Concat')) {
            return call_user_func_array([$this->_driver, 'Concat'], $args);
        }

        if (PHP_VERSION >= 5.3) {
            return call_user_func_array('parent::Concat', $args);
        }
        return call_user_func_array([$this,'parent::Concat'], $args);
    }
...
class ADOPDOStatement
{
    ...
    public function Execute($inputArr = false)
    {
        ...
        $rs = $this->_connectionID->Execute([false,$this->_stmt], $inputArr);
