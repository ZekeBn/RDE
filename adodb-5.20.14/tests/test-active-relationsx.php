...
class Rugrat extends ADOdb_Active_Record
{
    public function __construct()
    {
        parent::__construct('children', false, false, ['new' => true]);
    }
}
...
class Artist extends ADOdb_Active_Record
{
    public function __construct()
    {
        parent::__construct('artists', ['artistuniqueid']);
...
class Song extends ADOdb_Active_Record
{
    public function __construct()
    {
        parent::__construct('songs', ['recordid']);
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$person = new Person();
$people = $person->Find('id=1', false, false, ['loading' => ADODB_WORK_AR]);
ar_echo((ar_assert(found($people, "'name_first' => 'John'"))) ? "[OK] Found John\n" : "[!!] Find failed\n");
ar_echo((ar_assert(found($people, "'favorite_pet' => 'tortoise'"))) ? "[OK] Found relation: child\n" : "[!!] Missing relation: child\n");
ar_echo((ar_assert(found($people, "'name_first' => 'Joan'"))) ? "[OK] Found Joan\n" : "[!!] Find failed\n");
ar_echo((ar_assert(found($people, "'name_first' => 'JAMIE'"))) ? "[OK] Found JAMIE\n" : "[!!] Find failed\n");
...
$people = $person->Find('people.id=1', false, false, ['loading' => ADODB_JOIN_AR]);
ar_echo((ar_assert(found($people, "'name_first' => 'John'"))) ? "[OK] Found John\n" : "[!!] Find failed\n");
ar_echo((ar_assert(found($people, "'favorite_pet' => 'tortoise'"))) ? "[OK] Found relation: child\n" : "[!!] Missing relation: child\n");
ar_echo((ar_assert(found($people, "'name_first' => 'Joan'"))) ? "[OK] Found Joan\n" : "[!!] Find failed\n");
ar_echo((ar_assert(found($people, "'name_first' => 'JAMIE'"))) ? "[OK] Found JAMIE\n" : "[!!] Find failed\n");
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$child = new Child();
$children = $child->Find('id=1', false, false, ['loading' => ADODB_WORK_AR]);
...
$kids = $kid->Find('children.id=1', false, false, ['loading' => ADODB_WORK_AR]);
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$kid = new Kid('children');
$kids = $kid->Find('children.id=1', false, false, ['loading' => ADODB_LAZY_AR]);
ar_echo((ar_assert(found($kids, "'name_first' => 'Jill'"))) ? "[OK] Found Jill\n" : "[!!] Find failed\n");
...
$rugrats = $rugrat->Find('children.id=1', false, false, ['loading' => ADODB_WORK_AR]);
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$person = new Person();
$people = $person->Find('1=1', false, false, ['loading' => ADODB_LAZY_AR]);
ar_echo((ar_assert(found($people, "'name_first' => 'John'"))) ? "[OK] Found John\n" : "[!!] Find failed\n");
ar_echo((ar_assert(notfound($people, "'favorite_pet' => 'tortoise'"))) ? "[OK] No relation yet\n" : "[!!] Found relation when I shouldn't\n");
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$artist = new Artist();
$artists = $artist->Find('artistuniqueid=1', false, false, ['loading' => ADODB_JOIN_AR]);
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$song = new Song();
$songs = $song->Find('recordid=1', false, false, ['loading' => ADODB_JOIN_AR]);
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$artist = new Artist();
$artists = $artist->Find('artistuniqueid=1', false, false, ['loading' => ADODB_WORK_AR]);
ar_echo((ar_assert(found($artists, "'name' => 'Elvis Costello'"))) ? "[OK] Found Elvis Costello\n" : "[!!] Find failed\n");
ar_echo((ar_assert(found($artists, "'name' => 'No Hiding Place'"))) ? "[OK] Found relation: song\n" : "[!!] Missing relation: song\n");
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$song = new Song();
$songs = $song->Find('recordid=1', false, false, ['loading' => ADODB_WORK_AR]);
ar_echo((ar_assert(found($songs, "'name' => 'No Hiding Place'"))) ? "[OK] Found song\n" : "[!!] Find failed\n");
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$artist = new Artist();
$artists = $artist->Find('artistuniqueid=1', false, false, ['loading' => ADODB_LAZY_AR]);
ar_echo((ar_assert(found($artists, "'name' => 'Elvis Costello'"))) ? "[OK] Found Elvis Costello\n" : "[!!] Find failed\n");
...
ar_echo("-------------------------------------------------------------------------------------------------------------------\n");
$song = new Song();
$songs = $song->Find('recordid=1', false, false, ['loading' => ADODB_LAZY_AR]);
ar_echo((ar_assert(found($songs, "'name' => 'No Hiding Place'"))) ? "[OK] Found song\n" : "[!!] Find failed\n");
