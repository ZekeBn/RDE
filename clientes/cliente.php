...
<hr />
<h3>Viendo <?php echo $treg ?>&nbsp; <a href="cliente_listado_xls.php?ids=<?php echo intval($sucu) ?>" class="btn btn-sm btn-default"><span class="fa fa-file-excel-o"></span> Descargar Clientes</a> </h3>
