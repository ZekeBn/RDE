...
echo 'este impresor ya no se utiliza. por favor cierrelo. la impresion es automatica y no depende de este script';
exit;
...
<div class="resumenmini">
  <p><br />
    <br /><br /><br />  <form id="form1" name="form1" method="get" action="impresor_ticket_caja.php">
    Impresoras: <?php
