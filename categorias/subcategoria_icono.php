...
$consulta = "
SELECT * , sub_categorias.recarga_porc, sub_categorias.idsubcate, sub_categorias.descripcion
FROM sub_categorias
...
$rs = $prod;
$idcategoria = intval($prod->fields['idcategoria']);
$id = intval($prod->fields['idsubcate']);

if ($id == 0) {
    echo "Sub-Categoria inexistente!";
    exit;
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($valido == 'S') {
        ...
        imagepng($imgBig, "../ecom/gfx/fotosweb/subcat_".($id).".png");
        imagepng($imgChica, "../tablet/gfx/iconos/subcat_".($id).".png");

        header("location: subcategoria_icono.php?id=".$id);
        exit;
  ...
  <body class="nav-md">
	...
	<div class="clear"></div>
		<div class="cuerpo">
          ...
          <tbody>
            <tr>
              <td width="62"><a href="gest_subcategoria.php?cat=<?php echo $idcategoria; ?>"><img src="../img/homeblue.png" width="64" height="64" title="Regresar"/></a></td>
            </tr>
          </tbody>
        </table>
    </div>
...
<span class="resaltaditomenor">Agregar Icono a Sub-Categor&iacute;a</span><br /><br />
<h1 align="center" style="font-weight:bold; margin:0px; padding:0px; color:#0A9600;"><?php echo $rs->fields['descripcion']; ?></h1><br />

<input type="button" name="button" id="button" value="Otra Sub-categor&iacute;a" onmouseup="document.location.href='gest_subcategoria.php?cat=<?php echo $idcategoria; ?>'" />
</div>
...
$img = "../tablet/gfx/iconos/subcat_".$id.".png";
if (!file_exists($img)) {
    $img = "tablet/gfx/iconos/subcat_0.png";
}

$img2 = "../ecom/gfx/fotosweb/subcat_".$id.".png";
if (!file_exists($img2)) {
    $img2 = "../ecom/gfx/fotosweb/subcat_0.png";
}
?>
<form action="subcategoria_icono.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
